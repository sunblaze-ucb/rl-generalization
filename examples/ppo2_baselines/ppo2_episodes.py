"""Modified ppo2.py to generate fixed number of episodes instead steps"""
...
class Runner(object):
    ...
    def run(self):
        ...
        return (*map(sf01, (mb_obs, mb_returns, mb_dones, mb_actions, mb_values, mb_neglogpacs)),
            mb_states, epinfos, num_episodes)
...
def learn(*, policy, env, nsteps, total_episodes, ent_coef, lr,
    ...
    while True:
        ...
        obs, returns, masks, actions, values, neglogpacs, states, epinfos, num_episodes = runner.run() #pylint: disable=E0632
